# Project_template, просьба открыть readme и открыть в code тогда код схем копируется корректно и работает в plantuml или в editor или копировать проект в IDE
