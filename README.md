# Project_template, просьба открыть readme и открыть в code тогда код схем копируется коректно и работает в plantuml или в editor сли копировать проект в IDE
